namespace MegSWSApplication.Models
{
    ...
    {
        public int IDD_ID { get; set; }
        public string IDD_DIRECTOR_NO { get; set; }
        public int IDD_UNITID { get; set; }
        public int IDD_INVESTERID { get; set; }
        ...
        public string IDD_DISTRICTName { get; set; }
        public string IDD_STATEName { get; set; }
        public string IDD_COUNTRYName { get; set; }
    }
}
